(function(){
    ...
    var Item = Backbone.Model.extend({
        ...
        methodToURL: {
            'create': '/ckan-admin/quick-links/update',
            'read': '/ckan-admin/quick-links/read',
            'patch': '/ckan-admin/quick-links/patch',
            'update': '/ckan-admin/quick-links/update',
            'delete': '/ckan-admin/quick-links/delete'
        },
    ...
    var ItemView = Backbone.View.extend({
        tagName: 'div',
        className: '',
        template: _.template($('#quick_links-item-tpl').html()),
        events: {
            'change .form-control': 'onFieldEdit',
            'click .quick_links-item-header .toggle-tab-state': 'onTabChange',
            'click .quick_links-item-header .delete-item': 'onDelete'
        },
        initialize: function(){
    ...
    var ItemCollection = Backbone.Collection.extend({
        ...
        fetch: function () {
            var data = $("#quick_links-config-saved-data").text();
    ...
    var ItemCollectionView = Backbone.View.extend({
        el: '#quick_links-item-collection',
        events: {
    ...
    var CarouselConfigView = Backbone.View.extend({
        el: "#quick_links-config-main",
        events: {
            'click #add-quick_links-item': 'onNewItem',
            'click #save-quick_links': 'onSave'
        },
        ...
        _setupSortable: function(){
            ...
            Sortable.create(this.listView.el, {
                animation: 250,
                handle: ".quick_links-item-header",
                scroll: true,
                onUpdate: function (e){
