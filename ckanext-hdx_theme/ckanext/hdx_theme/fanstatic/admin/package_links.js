(function(){
    ...
    var Item = Backbone.Model.extend({
        ...
        methodToURL: {
            'create': '/ckan-admin/package-links/update',
            'read': '/ckan-admin/package-links/read',
            'patch': '/ckan-admin/package-links/patch',
            'update': '/ckan-admin/package-links/update',
            'delete': '/ckan-admin/package-links/delete'
        },
    ...
    var ItemView = Backbone.View.extend({
        tagName: 'div',
        className: '',
        template: _.template($('#package_links-item-tpl').html()),
        events: {
            'change .form-control': 'onFieldEdit',
            'click .package_links-item-header .toggle-tab-state': 'onTabChange',
            'click .package_links-item-header .delete-item': 'onDelete'
        },
        initialize: function(){
    ...
    var ItemCollection = Backbone.Collection.extend({
        ...
        fetch: function () {
            var data = $("#package_links-config-saved-data").text();
    ...
    var ItemCollectionView = Backbone.View.extend({
        el: '#package_links-item-collection',
        events: {
    ...
    var CarouselConfigView = Backbone.View.extend({
        el: "#package_links-config-main",
        events: {
            'click #add-package_links-item': 'onNewItem',
            'click #save-package_links': 'onSave'
        },
        ...
        _setupSortable: function(){
            ...
            Sortable.create(this.listView.el, {
                animation: 250,
                handle: ".package_links-item-header",
                scroll: true,
                onUpdate: function (e){
