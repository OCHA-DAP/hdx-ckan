// THIS IS A COPY OF THE preview_recline.js FROM THE RECLINEPREVIEW EXTENSION
// CHANGES: uses the url for dataproxy that is specified in the .ini file
...
this.ckan.module('reclinepreview', function (jQuery, _) {
  return {
    ...
    loadPreviewDialog: function (resourceData) {
      ...
      recline.Backend.DataProxy.dataproxy_url = $('#datapreview-url-div').text(); // CHANGED BY HDX
