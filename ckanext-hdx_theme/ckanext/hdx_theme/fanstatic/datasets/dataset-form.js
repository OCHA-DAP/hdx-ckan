$(document).ready(function(){
  ...
  $('#country-drop').change(function(){
    ...
    if($('#'+country).length == 0){
      ...
      if(country != '-1'){
        ...
        if (flag) {
          $('#selected_groups').append('<span class="filtered pill">'+country_name+' <i id="field-group-'+country+'" name="groups__'+(number_of_groups)+'__id" value="'+country+'" class="group_checked fa fa-trash"/></span>');
  ...
  $('#selected_groups').click(function(event){
    ...
    }else if(event.target.className == "group_checked fa fa-trash"){
