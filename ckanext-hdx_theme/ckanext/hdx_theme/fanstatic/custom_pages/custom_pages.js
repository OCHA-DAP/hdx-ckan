...
ckan.module('hdx_custom_pages', function ($, _) {
    ...
    return {
        initialize: function () {
            ...
            this.field_config = {
                "empty":[],
                "description":["section_title","section_long_description","max_height","m_max_height"],
                "map":["data_url","section_title","max_height","m_max_height"],
                "long_description":["section_title","section_long_description","max_height","m_max_height"],
                "key_figures":["data_url","section_title","section_description","max_height","m_max_height"],
                "interactive_data":["data_url","section_title","section_description","max_height","m_max_height"],
