...
// signup
var signupDangerAlert = signupDrawer ? signupDrawer.querySelector('.c-alert') : null;
...
// unsubscribe
var unsubscribeDangerAlert = unsubscribeDrawer ? unsubscribeDrawer.querySelector('.c-alert') : null;
...
var showAlert = function (alert, text) {
  if (!alert) return;
  var messageEl = alert.querySelector('.c-alert__message');
