CONSTANTS = {
    ...
    'FEATURE_PUBLIC_DATASETS': '''Access all public datasets''',
    'FEATURE_VIZ_TOOLS': '''Explore data visualizations''',
    'FEATURE_REGISTRATION_REQUIRED': '''No registration required''',

    'FEATURE_CONTACT_CONTRIBUTOR': '''Contact data contributors with questions''',
    'FEATURE_REQUEST_DATA': '''Become a member of an organization''',
    'FEATURE_MANAGE_NOTIFICATIONS': '''Manage your user dashboard''',

    'COLUMN_NO_ACCOUNT_LABEL': '''Search and download open data''',
    ...
    'COLUMN_INDIVIDUAL_ACCOUNT_WITH_ORG_HELP': '''If your organization would like to share data on HDX, please send an email to <a href="mailto:hdx@un.org">hdx@un.org</a> with some details and we will respond within 24 hours. ''',
