CONSTANTS = {
    'HERO_SECTION_TITLE': '''The HDX Humanitarian API (HAPI) is a way to access standardised indicators from multiple
    sources to automate workflows and visualisations''',
    'HERO_SECTION_DESCRIPTION': '''HAPI is in beta phase, and we are seeking feedback. To share your thoughts or join
    our Slack channel, send an email to <a href="{0}" title="Contact us">hdx@un.org</a>.''',
    'HERO_SECTION_LABEL': '''HDX HAPI Beta''',

    'DATA_COVERAGE_SECTION_TITLE': '''Data Coverage''',
    'DATA_COVERAGE_SECTION_DESCRIPTION': '''Our initial coverage aligns with the data included in the <a href="{0}"
    title="HDX Data Grids">HDX Data Grids</a>, which places the most important crisis data into six categories and 20
    sub-categories. Our beta version of HAPI covers 57 indicators across 22 countries with a <a href="{1}"
    title="Humanitarian Response Plan">Humanitarian Response Plan</a>.''',
    'DATA_COVERAGE_SECTION_PARAGRAPH': '''Refer to the <a href="{0}" target="_blank" title="HAPI - The Humanitarian
    API">documentation</a> for the latest coverage. <a href="{1}" title="Contact us">Contact us</a> to request
    additional indicators in future versions of HAPI. ''',
    ...
    'BE_INSPIRED_CARD_TEXT_VISUALIZATION': '''A dashboard with a selection of key figures, charts and a map for all
    countries in HAPI.''',
    ...
    'BE_INSPIRED_CARD_TEXT_CHATBOT': '''An early stage AI chatbot developed with DataKind to ask questions about the
    data.''',
