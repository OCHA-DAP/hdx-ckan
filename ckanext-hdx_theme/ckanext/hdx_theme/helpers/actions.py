...
send_request_membership_mail_template = str(
    '<br/>You are receiving this message because you are an administrator of the {org_title} organisation on HDX and a user called {user_fullname} whose email address is {user_email} has requested to join your organisation on HDX. The user included the following message with his/her request: <br/>{user_message} <br/><br/>'
