...
send_request_membership_mail_template = str(
    '<br/><br/>You are receiving this message because you are an administrator of the {org_title} organisation on HDX and a user called {user_fullname} whose email address is {user_email} has requested to join your organisation on HDX. The user included the following message with his/her request: <br/>{user_message} <br/><br/>'
    'If you know this user and would like to add him/her to your organisation, please log on to HDX and click on the ADD MEMBER link for your organisation at {org_add_member_url} . Enter \'{user_username}\' in the username box and assign one of the following roles to the user: <br/>'
