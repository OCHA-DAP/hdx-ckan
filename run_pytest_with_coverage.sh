...
'--cov=ckanext-hdx_user_extra --cov=ckanext-hdx_service_checker --cov=ckanext-sitemap --cov=ckanext-ytp-request  '\
'--cov=ckanext-hdx_dataviz --cov=ckanext-hdx_smtp_assumerole  '\
