...
class Permissions(object):
    ...
    PERMISSION_MANAGE_DATASERIES = 'permission_manage_dataseries'
    LABEL_PERMISSION_MANAGE_DATASERIES = 'Manage Dataseries'
    PERMISSION_MANAGE_P_CODES = 'permission_manage_p_codes'
    LABEL_PERMISSION_MANAGE_P_CODES = 'Manage P-Codes'
    ...
    ALL_PERMISSIONS_LABELS_DICT = {
        ...
        PERMISSION_MANAGE_DATASERIES: LABEL_PERMISSION_MANAGE_DATASERIES,
        PERMISSION_MANAGE_P_CODES: LABEL_PERMISSION_MANAGE_P_CODES,
