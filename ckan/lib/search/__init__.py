...
def rebuild(package_id: Optional[str] = None,
    ...
    if use_hdx_reindex:
        ...
        hdx_reindexer.rebuild(package_id=package_id, only_missing=only_missing, force=force, refresh=not clear,
                              defer_commit=defer_commit, package_ids=package_ids, quiet=quiet)
    else:
