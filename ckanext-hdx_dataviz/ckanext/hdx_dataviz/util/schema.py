...
from ckan.lib.navl.validators import default, ignore_missing, ignore_empty, not_empty
...
def showcase_update_schema_wrapper(original_schema):
    def schema_function():
        ...
        schema.update({
            ...
            'dataviz_label': [_has_dataviz_gallery_permission, not_empty, six.text_type, _check_string_length, get_converter('convert_to_extras')],
