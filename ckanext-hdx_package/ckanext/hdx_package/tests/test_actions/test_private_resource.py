...
class TestHDXPrivateResource(hdx_test_with_inds_and_orgs.HDXWithIndsAndOrgsTest):
    ...
    ### THIS TEST NO LONGER NEEDED BECAUSE WE'RE NO LONGER
    ### OVERRIDING THIS PART OF CKAN. COVERED BY CKAN CORE TESTS
    ...
    #     dwld_url = h.url_for(controller='resource',
    #                          action='download', id=package['resources'][0]['id'] label='test_folder/hdx_test.csv')
